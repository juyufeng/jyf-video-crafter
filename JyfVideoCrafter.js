...
(function (global, factory) {
  ...
  function renderAsWebP(canvas, quality) {
    let
      frame =  kksTp(canvas) === 'string' && /^data:image\/webp/.test(canvas)
        ? canvas
   ...
   */
  let JyfVideo = function (ArrayBufferDataStream, BlobBuffer) {
  ...
  const JyfVideoCrafter = new JyfVideo(ArrayBufferDataStream, BlobBuffer());
